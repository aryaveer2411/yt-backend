...
import { registerUser, getAllUSers, deleteUser, logOutUser, loginUser, refreshAccessToken, changePassword, getCurrentUser, updateAccountDetails, updateUserMedia } from "../controllers/user.controller.js";
...
userRouter.route("/update-user-media").put(verifyJwt,upload.fields([
    {
        name: "avatar",
        maxCount: 1
    },
